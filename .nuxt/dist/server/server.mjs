...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.cd318d37.js").then((m) => m.default || m)
  },
  {
    name: "thank-you-beta",
    path: "/thank-you-beta",
    ...
    component: () => import("./_nuxt/thank-you-beta.9ef13159.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.b465ceed.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default.21703b9d.js").then((m) => m.default || m))
};
