...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderSuspense, ssrRenderComponent } from "vue/server-renderer";
...
const appHead = { "meta": [], "link": [{ "rel": "icon", "type": "image/png", "href": "/favicon.png" }, { "rel": "stylesheet", "href": "https://fonts.googleapis.com/css2?family=Inter:wght@100;300;400;500;700;900&display=swap" }, { "rel": "stylesheet", "href": "/assets/main.css" }], "style": [], "script": [], "noscript": [], "charset": "utf-8", "viewport": "width=device-width, initial-scale=1" };
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({
    id: "intro",
    class: "bg-white mb-0"
  }, _attrs))}><div class="container px-4 py-5"><div class="row"><div class="col-12 col-md-6 mb-5"><img alt="Image"${ssrRenderAttr("src", _imports_0)} class="img-fluid" width="800px"></div><div class="col-12 col-md-6 text-md-left section-intro"><h3 class="h1 pb-4">Tentang Alun</h3><p>Teknologi inovatif Alun adalah perpaduan antara kecerdasan buatan (AI) dan psikologi musik untuk mengkreasikan musik yang dipersonalisasi dan bertujuan untuk membantu relaksasi, fokus, serta kebugaran.</p><p>Berikut adalah nilai-nilai yang kami anut dalam mengembangkan aplikasi Alun:</p><ol><li aria-level="1"><strong>Teknologi</strong> - Dengan bantuan teknologi kecerdasan buatan (AI) dan pembelajaran mesin (machine learning), Alun memproduksi komposisi musik menggunakan instrumen nusantara yang dipersonalisasi sesuai waktu, cuaca, dan suasana hati pengguna.</li><li aria-level="1"><strong>Psikologi</strong> - Algoritma musik yang dihasilkan Alun bertujuan untuk membantu mengoptimalkan kesehatan mental berdasarkan riset*.</li><li aria-level="1"><strong>Etnomusikologi</strong> - Model data pembelajaran mesin yang kami gunakan berasaskan etika serta bertanggung jawab terhadap budaya nusantara.</li></ol></div></div></div></section>`);
}
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "text-center bg-white" }, _attrs))}><div class="container"><div class="row pb-5 mb-0"><div class="col-12 col-md-3 py-5"><i class="fa-solid fa-headphones-simple fa-4x"></i><h3 class="pt-4 h3 fs-5">Musik yang Dipersonalisasi</h3></div><div class="col-12 col-md-3 py-5"><i class="fa-solid fa-flask fa-4x"></i><h3 class="pt-4 h3 fs-5">Didukung oleh Sains</h3></div><div class="col-12 col-md-3 py-5"><i class="fa-solid fa-code fa-4x"></i><h3 class="pt-4 h3 fs-5">Teknologi Kecerdasan Buatan</h3></div><div class="col-12 col-md-3 py-5"><i class="fa-solid fa-mobile fa-4x"></i><h3 class="pt-4 h3 fs-5">Mudah Digunakan</h3></div></div></div></section>`);
}
...
const _routes = [
  {
    name: "index",
    path: "/",
    file: "/Users/priyonosantosa/Documents/prys/repo/alun-web/pages/index.vue",
    children: [],
    meta: meta$1,
  ...
  },
  {
    name: "thank-you-beta",
    path: "/thank-you-beta",
    file: "/Users/priyonosantosa/Documents/prys/repo/alun-web/pages/thank-you-beta.vue",
    children: [],
    meta,
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Instrumen musik nusantara yang dikreasikan oleh kecerdasan buatan (AI) dan dipersonalisasi untuk membantu mengoptimalkan kesehatan mental."
        }
      ],
      bodyAttrs: {
        class: "alun"
