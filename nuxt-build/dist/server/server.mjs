...
const Herobeta_vue_vue_type_style_index_0_lang = "";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.480ac271.js").then((m) => m.default || m)
  },
  {
    name: "thank-you-beta",
    path: "/thank-you-beta",
    ...
    component: () => import("./_nuxt/thank-you-beta.75b67a8c.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.f0bd555a.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default.27d6d800.js").then((m) => m.default || m))
};
